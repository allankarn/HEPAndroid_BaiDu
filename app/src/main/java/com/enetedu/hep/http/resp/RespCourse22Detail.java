...
public class RespCourse22Detail extends RespBase {
    ...
    public void onResp(String result) {
        try {
            ...
            JSONObject course2model = resultData.getJSONObject("coursechoicemodel");
    ...
    public String toString() {
        return "RespCourse22Detail{" +
                "course2DetailEntity=" + course2DetailEntity +
                ", course2ModelEntity=" + course2ModelEntity +
                ", teacherListEntityArrayList=" + teacherListEntityArrayList +
                '}';
    }
}
