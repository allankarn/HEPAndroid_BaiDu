...
public class MainCenterList extends BaseEntityImpl {
    private int id;
    ...
    public MainCenterList() {
    }

    public MainCenterList(int id, String centerType, String name, String money, ArrayList<TjList> tjLists) {
        this.id = id;
