...
public class Course3ViewListEntity extends BaseEntityImpl {
    private int id;
    private String Name;
    ...
    public Course3ViewListEntity() {
    }

    public Course3ViewListEntity(int id, String name, String courseType, String courseStatus, String startTime, String endTime, String createTime, String finishTime, String is_payoffed, String numbers, String is_video_finished, String credit_remain_event, String is_work_finished, String statusName, int courehour, int is_new, int is_postpone, String operate, ArrayList<CourseList> courseLists) {
        this.id = id;
        Name = name;
    ...
    ReqFinishedList reqFinishedList;
    public void getFinishedList(String UserToKen, int userid, int PageNo, int PageSize, final OnBaseResp onBaseResp) {
        if (reqFinishedList == null) reqFinishedList = new ReqFinishedList();
        reqFinishedList.setUserToKen(UserToKen);
        reqFinishedList.setUserID(userid);
        reqFinishedList.setPageNo(PageNo);
        reqFinishedList.setPageSize(PageSize);

        HEPMSProxy.GetFinishedList(reqFinishedList, new IHEPMSProxy.OnResp() {
            @Override
