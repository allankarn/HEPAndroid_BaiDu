...
import com.enetedu.hep.utils.CustomVideoView;

public class PlayActivity extends BaseActivityPro {
    ...
    private RelativeLayout mRelTopBar;
    private ImageView mImgPlay;
    /**
     * 00:00:00
     */
  //  private TextView mTxtProssTime;
    private SeekBar mSeekBar;
    /**
     * 00:00:00
     */
   // private TextView mTxtTotalTime;
    private ImageView mImgScreenSwitch;
    private LinearLayout mRelBottomBar;
    private RelativeLayout mRelVideoLayout;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initData();
        initViewOnClick();
        videoView.setVideoURI(Uri.parse("http://vfx.mtime.cn/Video/2017/03/31/mp4/170331093811717750.mp4"));
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        if (screenOritentation == Configuration.ORIENTATION_LANDSCAPE) {
            ...
            //竖屏时处理
            setVideoScreenSize(ViewGroup.LayoutParams.MATCH_PARENT, dip2px(PlayActivity.this, 240));
            screen_flag = true;
