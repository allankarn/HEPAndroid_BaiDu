...
public class ZbStudyAdapter extends RecyclerView.Adapter {
    public ArrayList<CourseViewListEntity> mList = new ArrayList<>();
    ...
    public void addData(ArrayList<CourseViewListEntity> objects) {
        mList.clear();
        mList.addAll(objects);
        notifyDataSetChanged();
    }

    public void newaddData(ArrayList<CourseViewListEntity> objects) {
        mList.addAll(objects);
        notifyDataSetChanged();
    }
