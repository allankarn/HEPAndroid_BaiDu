...
public class XxzAdapter extends RecyclerView.Adapter {

    public ArrayList<Course2ViewListEntity> mList = new ArrayList<>();
    private OnItemListener mlistener;
    private static final String TAG = "XxzAdapter";
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, final int i) {
        ...
        if (type == 1) {
            ...
            //holder.tv_neirong.setText(mList.get(i).getName());
        }
    ...
    public void addData(ArrayList<Course2ViewListEntity> objects) {
        mList.clear();
        mList.addAll(objects);
        notifyDataSetChanged();
    }

    public void newaddData(ArrayList<Course2ViewListEntity> objects) {
        mList.addAll(objects);
        notifyDataSetChanged();
    }
